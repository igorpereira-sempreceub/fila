...
public class FilaTest {
	...
	public void getTamanhoTest() {
		...
		fila.entrarNaFila(new Elemento(1));
		Assert.assertTrue(fila.getTamanho() == 1);

		fila.entrarNaFila(new Elemento(2));
		Assert.assertTrue(fila.getTamanho() == 2);

		fila.entrarNaFila(new Elemento(3));
		Assert.assertTrue(fila.getTamanho() == 3);

		fila.entrarNaFila(new Elemento(4));
		Assert.assertTrue(fila.getTamanho() == 4);

	}

	@Test
	public void entrarNaFilaTest() {
	...
	public void getPosicaoNaFilaTest() {
		Elemento elemento0 = new Elemento(0);
		Elemento elemento1 = new Elemento(1);
		Elemento elemento2 = new Elemento(2);
		Elemento elemento3 = new Elemento(3);
		Elemento elemento4 = new Elemento(4);
		Elemento elemento5 = new Elemento(5);
